...
void CoordinadorPacman::Dibuja()
{
	if (estado == INICIO)
	{
		...
		ETSIDI::printxy("Bienvenido al PACMAN.", -6, 10);
		ETSIDI::setFont("fuentes/Bitwise.ttf", 12);
		ETSIDI::printxy("PULSE LA TECLA -E- PARA EMPEZAR", -8, 7);
		ETSIDI::printxy("Use los cursores izquierdo, derecho, arriba y abajo para moverse", -8, 6);
		ETSIDI::printxy("Si quiere salir pulse la tecla -S-", -8, 5);
	}
